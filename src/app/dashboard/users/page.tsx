    ...
    <div className="space-y-5">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div>
          ...
          <p className="mt-0.5 text-sm text-zinc-500">{userCount} registered users</p>
        </div>
        <Suspense fallback={<div className="h-9 w-24 bg-zinc-800 rounded animate-pulse" />}>
          <UserActions />
        </Suspense>
      </div>
...
async function UsersServerTable() {
